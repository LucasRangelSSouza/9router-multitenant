...
export async function handleTts(request) {
  ...
  if (comboModels) {
    ...
    return handleComboChat({
      body,
      models: comboModels,
      handleSingleModel: (b, m) => handleSingleModelTts(b, m, responseFormat, language, style, tenantId),
      log,
      comboName: modelStr,
      comboStrategy,
      comboStickyLimit,
  ...
  return handleSingleModelTts(body, modelStr, responseFormat, language, style, tenantId);
}

async function handleSingleModelTts(body, modelStr, responseFormat, language, style, tenantId = null) {
