...
vi.mock("@/sse/services/auth.js", () => ({
  ...
  getApiKeyAuth: mocks.getApiKeyAuth,
...
describe("Gemini native v1beta endpoint", () => {
  beforeEach(() => {
    ...
    mocks.getApiKeyAuth.mockResolvedValue({ isActive: true, tenantId: null });
  ...
  it("accepts Google-style client keys without forwarding them upstream", async () => {
    ...
    expect(mocks.getApiKeyAuth).toHaveBeenCalledWith("client-router-key");
